...
export default function Member(props) {
  ...
  useEffect(() => {	
	...
	function handleCeasedMemberConfirm() {
		...
		let ceasedRec = lodashCloneDeep(memberArray[radioRecord]);
		ceasedRec.ceasedDate = emurDate1.toDate();
		ceasedRec.ceased = true;
		tmpArray.push(ceasedRec);
	...
	{(isDrawerOpened === "CEASED") &&
		<ValidatorForm align="center" className={classes.form} onSubmit={handleCeasedMemberConfirm}>
